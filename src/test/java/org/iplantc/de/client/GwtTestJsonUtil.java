...
public class GwtTestJsonUtil extends GWTTestCase {
	 ...
	 */
		...
		/**
		 * JsFile
		 * [{"id":"330", "name":"iptol180_gnetales.new", "status":"", "type":"Newick", "uploaded":"2010-04-29 11:16:43.453"},
		 *  {"id":"294", "name":"gnetales.nex", "status":"", "type":"NEXUS with tree data", "uploaded":"2010-04-29 11:16:22.533"}]	
		 */
	...
	public void testArrayOfWithJsFileDoubleQuote() {
		...
		fileInfos = JsonUtil.asArrayOf("[{\"id\":\"330\", " +
						...
						"\"type\":\"NEXUS with tree data\", " +
						"\"uploaded\":\"2010-04-29 11:16:22.533\"}]");
	...
	/**
	 * JsTrait example 
	 * [{"filename":"geospiza_valid.csv","id":"1139","uploaded":"2010-05-04 15:47:49.385"}]
	 */
