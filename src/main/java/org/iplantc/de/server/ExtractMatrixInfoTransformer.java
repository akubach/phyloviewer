...
/**
 * When a user wishes to obtain the list of matrices, we only need to return a few pieces
 * of information in order to identify each matrix.
 * 
	...
	protected Object doTransform(Object arg0, String arg1) throws TransformerException
	{
		...
		else
		{
			throw new TransformerException(MessageFactory
					.createStaticMessage("Received object that was not a File or list of Matrices"));
		}
