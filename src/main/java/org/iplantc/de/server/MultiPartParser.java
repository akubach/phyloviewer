...
public class MultiPartParser
{
	...
	/**
	 * Read the next part arriving in the stream. Will be a <code>FilePart</code> or
	 * <code>null</code> to indicate there are no more parts to read. The order of arrival
