...
/**
 * Provides several constants that we use to secure our services. The REMOTE constants are
 * the names of the attributes that are provided by Shibboleth. The LOCAL constants are
 * the names of the attributes that we use internally. These names are different so as to
 * avoid potential conflicts. There's also an attribute map that is used to map the
...
public class DESecurityConstants
{
	...
	// The names of the attributes containing the unique identifier of the Shibboleth
	// identity provider.
	...
	// The names of the attributes containing the number of assertions known to our
	// service provider.
	...
	// The names of the attributes containing the user's unscoped organization
	// affiliation.
	...
	/**
	 * Returns a collection of local attribute names that can be used for building new
	 * SAML assertions.
	 * 
