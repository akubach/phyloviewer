...
/**
 * Transform a Matrix into a MatrixData that can then converted into a JSON string to be
...
public class MatrixTransformer
{
	...
	/**
	 * This transform is only to handle exceptions. The issue pertains to the calling of
	 * the tree transform service when there is an exception in the payload encoded as a
	 * string. When that happens, we don't have a tree to transform. By including this
