...
public class DefaultStartMenuComposer extends StartMenuComposer 
{
	...
	{
		MenuItem item = buildMenuItem(displayStrings.myData(),constants.windowTag(),constants.myDataTag(),"icon-grid");				
		menu.add(item);		
	}
	...
	{
		MenuItem item = buildMenuItem(displayStrings.myJobs(),constants.windowTag(),constants.myJobsTag(),"icon-grid");				
		menu.add(item);
	}
	...
	{
		MenuItem item = buildMenuItem(displayStrings.logout(),constants.actionTag(),constants.logoutTag(),"logout");		
		menu.addTool(item);
	}
