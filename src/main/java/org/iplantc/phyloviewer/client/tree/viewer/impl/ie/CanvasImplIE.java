...
package org.iplantc.phyloviewer.client.tree.viewer.impl.ie;
...
public class CanvasImplIE extends CanvasImpl {
	...
	private native void insert(String where, String html) /*-{
		this.@org.iplantc.phyloviewer.client.tree.viewer.impl.CanvasImpl::element.insertAdjacentHTML(where, html);
	}-*/;
