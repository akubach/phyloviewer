 ...
 * Provide an abstract callback superclass that can be subclassed to add specific behaviors (such as logging).
 * Give the superclass the ability to handle the RPC result before the subclass.
 */
