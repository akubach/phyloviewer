 ...
 *            Classes extending this should implement the abstract methods.
 *            Provide an abstract call back superclass that can be sub-classed to
 *            add specific behaviors (such as logging). Give the superclass the
 *            ability to handle the RPC result before the subclass.
 */
public abstract class AbstractAsyncHandler implements AsyncCallback<Object>,
		AsyncHandler 
{
