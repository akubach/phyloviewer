...
import org.iplantc.iptol.client.events.FileEditorWindowDirtyEventHandler;
import org.iplantc.iptol.client.events.FileEditorWindowSavedEvent;
import org.iplantc.iptol.client.events.FileEditorWindowSavedEventHandler;
...
import org.iplantc.iptol.client.views.widgets.portlets.ProvenancePortletTabPanel;
import org.iplantc.iptol.client.views.widgets.portlets.panels.NewTreePanel;
...
public class FileEditorWindow extends ProvenanceWindow 
{
	...
	protected void getTreeImage(String json)
	{
		...
		{			
			...
			NewTreePanel panelTree = new NewTreePanel(file,json);		
