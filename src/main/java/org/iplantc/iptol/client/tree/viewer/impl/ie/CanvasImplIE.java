...
package org.iplantc.iptol.client.tree.viewer.impl.ie;
...
import org.iplantc.iptol.client.tree.viewer.impl.CanvasImpl;
...
public class CanvasImplIE extends CanvasImpl {
	...
	private native void insert(String where, String html) /*-{
		this.@org.iplantc.iptol.client.tree.viewer.impl.CanvasImpl::element.insertAdjacentHTML(where, html);
	}-*/;
